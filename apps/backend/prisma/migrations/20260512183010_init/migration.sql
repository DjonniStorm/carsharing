...
CREATE TABLE "geo_zone_version" (
    ...
    "rules" JSONB,
    "price_per_minute" DECIMAL(19,2) NOT NULL DEFAULT 0,
    "price_per_km" DECIMAL(19,2) NOT NULL DEFAULT 0,
    "pause_price_per_minute" DECIMAL(19,2) NOT NULL DEFAULT 0,
    "tariff_preset_id" UUID,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "trip" (
    ...
    "geo_zone_version_id" UUID NOT NULL,
    "pause_started_at" TIMESTAMP(3),
    "total_paused_sec" INTEGER NOT NULL DEFAULT 0,
    "start_lat" DECIMAL(9,6),
    "start_lon" DECIMAL(9,6),
    "finish_lat" DECIMAL(9,6),
    "finish_lng" DECIMAL(9,6),
    "distance_meters" DOUBLE PRECISION,
    "charged_minutes" DOUBLE PRECISION,
    "charged_km" DOUBLE PRECISION,
    "price_time" DECIMAL(19,2),
    "price_distance" DECIMAL(19,2),
    "price_pause" DECIMAL(19,2),
    "price_total" DECIMAL(19,2),
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    "car_plate_snapshot" TEXT,
    "car_display_name_snapshot" TEXT,
